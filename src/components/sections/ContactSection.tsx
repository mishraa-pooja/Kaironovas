      ...
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="text-gray-900 dark:text-white">Discuss Your</span>
            <br />
          ...
          >
            <div className="space-y-6">
              ...
              {contactInfo.map((info, index) => {
                ...
                return (
                  <Card key={index} className="p-6 border-0 dark:border dark:border-white/10 bg-white dark:bg-white/[0.04] shadow-lg hover:shadow-xl transition-shadow">
                    <CardContent className="p-0">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-indigo-600 dark:text-indigo-300 font-medium mb-1">{info.details}</p>
              ...
              <Card className="p-6 border-0 shadow-lg bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-500/10 dark:to-violet-500/10 dark:border dark:border-white/10">
                <CardContent className="p-0">
                  <div className="flex items-center space-x-3 mb-3">
                    ...
                    <h4 className="font-semibold text-gray-900 dark:text-white">Book a Strategy Call</h4>
                  </div>
                  <p className="text-gray-600 dark:text-slate-400 text-sm mb-4">
                    We&apos;ll identify one high-impact workflow and map out a private AI system for it.
                  </p>
                  <Button variant="outline" size="sm" className="w-full dark:border-white/15 dark:bg-transparent dark:text-slate-200 dark:hover:bg-white/5">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border border-gray-300 dark:border-white/10 dark:bg-white/[0.06] dark:text-white dark:placeholder:text-slate-500 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 border border-gray-300 dark:border-white/10 dark:bg-white/[0.06] dark:text-white dark:placeholder:text-slate-500 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors resize-none"
